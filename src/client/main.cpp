...
void doRegResponse(json& responsejs) {
    if (responsejs["errno"].get<int>() != 0) {
        cerr << " name is already exist, reguster error!" << endl;
    } else {
        cout << " name register success, userid is" << responsejs["id"] << ", do not dorget it!" << endl;
    }
}
